...
function katex_jsdelivr_setting_render(  ) { 
	...
	?>
	<input type='checkbox' name='katex_settings[katex_jsdelivr_setting]' <?php checked( $options['katex_jsdelivr_setting'], 1 ); ?> value='1'>
	&nbsp; <a href="http://www.jsdelivr.com" target="_blank">jsDelivr</a> is a free, open source CDN. Using it will speed up the loading of KaTeX.
	<?php
